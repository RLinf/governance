# Charter for the RLinf Organization

This is the organizational charter for the RLinf Organization (the "Organization"). By adding their name to the [Steering Committee.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.

## 1. Mission

RLinf's mission is to build open-source reinforcement learning infrastructure for embodied and agentic AI, providing interoperable tools, libraries, and resources that support research and practical development across RLinf projects.
